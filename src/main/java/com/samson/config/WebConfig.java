...
public class WebConfig extends WebMvcConfigurerAdapter{
	...
	public DriverManagerDataSource dataSource() {
	    ...
	    driverManagerDataSource.setUrl("jdbc:mysql://127.7.50.130:3306/javacv");
	    driverManagerDataSource.setUsername("adminV6RZhLQ");
	    driverManagerDataSource.setPassword("chNh52bGaVbC");
